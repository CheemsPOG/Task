# System_Overview_Design_137_Register_Update_Chart_Template_(TV)

## Processing Overview

---

The API registers or updates chart template information.

   1. Receive request information ("chart template name", "chart template content")

   2. Register or update the same information in the "TV chart template master"
...
api->>hstr:Request information ("chart template name", "chart template content") 
