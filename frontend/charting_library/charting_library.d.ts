...
export interface ChartPropertiesOverrides {
	...
	/**
	 * Main series legend exchanges visibility.
	 *
	 * @default true
	 */
...
export interface ChartingLibraryWidgetOptions {
	 ...
	 * See the [list of supported time zones](https://www.tradingview.com/charting-library-docs/latest/ui_elements/timezones.md#supported-time-zones) for available values. Set it to `exchanges` to use the exchanges time zone. Use the {@link ChartingLibraryWidgetOptions.overrides} section if you wish to override the default value.
	 *
	 * ```javascript
...
export interface Exchange {
	/** Value to be passed as the `exchanges` argument to `searchSymbols` */
	value: string;
...
export interface IDatafeedChartApi {
	 ...
	 * @param exchange The requested exchanges. Empty value means no filter was specified
...
export interface LibrarySymbolInfo {
	/**
	 * It is a symbol name within an exchanges, such as `AAPL` or `9988` (Hong Kong).
	 * Note that it should not contain the exchanges name.
	...
	corrections?: string;
	/**
	 * Traded exchanges (current (proxy) exchanges).
	...
	exchange: string;
	/**
	 * short name of the exchanges where this symbol is traded (real listed exchanges).
	 * The name will be displayed in the chart legend for this symbol.
	 *
	 * @example "NYSE"
	 */
	...
	/**
	 * Time zone of the exchanges for this symbol. We expect to get the name of the time zone in `olsondb` format.
	...
	/**
	 * URL of image to be displayed as the logo for the exchanges. The `show_exchange_logos` featureset needs to be enabled for this to be visible in the UI.
	 *
...
export interface PineJSStd {
	...
	/**
	 * Year of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Current bar year in exchanges timezone.
	 */
	year(context: IContext, time?: number): number;
	/**
	 * Month of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Current bar month in exchanges timezone.
	 */
	month(context: IContext, time?: number): number;
	/**
	 * Week number of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Week number of current bar in exchanges timezone.
	 */
	weekofyear(context: IContext, time?: number): number;
	/**
	 * Day of month for current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Day of month for current bar time in exchanges timezone.
	 */
	dayofmonth(context: IContext, time?: number): number;
	/**
	 * Day of week for current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Day of week for current bar time in exchanges timezone.
	 */
	dayofweek(context: IContext, time?: number): number;
	/**
	 * Hour of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Current bar hour in exchanges timezone.
	 */
	hour(context: IContext, time?: number): number;
	/**
	 * Minute of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Current bar minute in exchanges timezone.
	 */
	minute(context: IContext, time?: number): number;
	/**
	 * Second of current bar time in exchanges timezone.
	 *
	 * @param context - PineJS execution context.
	 * @param time optional time. Current bar time will be used by default.
	 * @returns Current bar second in exchanges timezone.
	 */
	...
	/**
	 * True Strength Indicator. It uses moving averages of the underlying momentum of a financial instrument.
	 *
	 * @param source - Source series.
	 * @param shortLength - Length (number of bars back).
	 * @param longLength - Length (number of bars back).
	 * @param context - PineJS execution context.
	 * @returns True Strength Indicator. A value in range `[-1, 1]`
	 */
...
export interface StudyOverrides {
	...
	/** Default value: `#787B86` */
	"True Strength Indicator.zero.color": string;
	/** Default value: `2` */
	"True Strength Indicator.zero.linestyle": number;
	/** Default value: `1` */
	"True Strength Indicator.zero.linewidth": number;
	/** Default value: `true` */
	"True Strength Indicator.zero.visible": boolean;
	/** Default value: `0` */
	"True Strength Indicator.zero.value": number;
	/** Default value: `15` */
	"True Strength Indicator.True Strength Indicator.display": number;
	/** Default value: `0` */
	"True Strength Indicator.True Strength Indicator.linestyle": number;
	/** Default value: `1` */
	"True Strength Indicator.True Strength Indicator.linewidth": number;
	/** Default value: `line` */
	"True Strength Indicator.True Strength Indicator.plottype": LineStudyPlotStyleName;
	/** Default value: `false` */
	"True Strength Indicator.True Strength Indicator.trackprice": boolean;
	/** Default value: `0` */
	"True Strength Indicator.True Strength Indicator.transparency": number;
	/** Default value: `#2196F3` */
	"True Strength Indicator.True Strength Indicator.color": string;
	/** Default value: `15` */
	"True Strength Indicator.signal.display": number;
	/** Default value: `0` */
	"True Strength Indicator.signal.linestyle": number;
	/** Default value: `1` */
	"True Strength Indicator.signal.linewidth": number;
	/** Default value: `line` */
	"True Strength Indicator.signal.plottype": LineStudyPlotStyleName;
	/** Default value: `false` */
	"True Strength Indicator.signal.trackprice": boolean;
	/** Default value: `0` */
	"True Strength Indicator.signal.transparency": number;
	/** Default value: `#E91E63` */
	"True Strength Indicator.signal.color": string;
	/**
	 * - Default value: `25`
	 * - Input type: `integer`
	 * - Min: `1`
	 * - Max: `4999`
	 */
	"True Strength Indicator.long": number;
	/**
	 * - Default value: `13`
	 * - Input type: `integer`
	 * - Min: `1`
	 * - Max: `4999`
	 */
	"True Strength Indicator.short": number;
	/**
	 * - Default value: `13`
	 * - Input type: `integer`
	 * - Min: `1`
	 * - Max: `4999`
	 */
	"True Strength Indicator.siglen": number;
	/** Default value: `15` */
	...
	/** Default value: `15` */
	"zigzag.plot.display": number;
	/** Default value: `0` */
	"zigzag.plot.linestyle": number;
	/** Default value: `2` */
	"zigzag.plot.linewidth": number;
	/** Default value: `line` */
	"zigzag.plot.plottype": LineStudyPlotStyleName;
	/** Default value: `false` */
	"zigzag.plot.trackprice": boolean;
	/** Default value: `0` */
	"zigzag.plot.transparency": number;
	/** Default value: `#2196F3` */
	"zigzag.plot.color": string;
	/**
	 * - Default value: `5`
	 * - Input type: `float`
	 * - Min: `0.001`
 ...
 * `exchanges` is a special "timezone" that means the timezone of a currently active symbol.
...
/**
 * Overrides for the 'True Strength Indicator' indicator.
 *
 * Use these properties to customize indicator via {@link IChartWidgetApi.createStudy} and {@link IStudyApi.applyOverrides}.
 */
export interface TrueStrengthIndexIndicatorOverrides {
	...
	"zero.value": number;
	/** Default value: `15` */
	"true strength indicator.display": number;
	/** Default value: `0` */
	"true strength indicator.linestyle": number;
	/** Default value: `1` */
	"true strength indicator.linewidth": number;
	/** Default value: `line` */
	"true strength indicator.plottype": LineStudyPlotStyleName;
	/** Default value: `false` */
	"true strength indicator.trackprice": boolean;
	/** Default value: `0` */
	"true strength indicator.transparency": number;
	/** Default value: `#2196F3` */
	"true strength indicator.color": string;
	/** Default value: `15` */
	"signal.display": number;
	/** Default value: `0` */
	"signal.linestyle": number;
...
/**
 * Overrides for the 'ZigZag' indicator.
 *
 * Use these properties to customize indicator via {@link IChartWidgetApi.createStudy} and {@link IStudyApi.applyOverrides}.
 */
...
/** Show/Hide the exchanges label from the displayed label @default false */
